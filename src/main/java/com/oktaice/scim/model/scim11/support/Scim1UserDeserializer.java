package com.oktaice.scim.model.scim11.support;
...
import static com.oktaice.scim.model.scim11.ScimUser.SCHEMA_USER_CORE;

@JsonComponent
public class Scim1UserDeserializer extends JsonDeserializer<ScimUser> {
